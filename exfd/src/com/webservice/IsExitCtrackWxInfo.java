 ...
 */
            ...
            /**
            *  IsExitCtrackWxInfo bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class IsExitCtrackWxInfo
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = isExitCtrackWxInfo
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":isExitCtrackWxInfo",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "isExitCtrackWxInfo",
    ...
    public static class Factory{
        ...
        */
        public static IsExitCtrackWxInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            IsExitCtrackWxInfo object =
                new IsExitCtrackWxInfo();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"isExitCtrackWxInfo".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (IsExitCtrackWxInfo)com.webservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
