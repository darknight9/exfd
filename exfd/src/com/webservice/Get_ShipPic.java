 ...
 */
            ...
            /**
            *  Get_ShipPic bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Get_ShipPic
    ...
    public static class Factory{
        ...
        */
        public static Get_ShipPic parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Get_ShipPic object =
                new Get_ShipPic();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"get_ShipPic".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Get_ShipPic)com.webservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
