 ...
 */
            ...
            /**
            *  GetMobileTrackCount bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetMobileTrackCount
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = getMobileTrackCount
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getMobileTrackCount",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getMobileTrackCount",
    ...
    public static class Factory{
        ...
        */
        public static GetMobileTrackCount parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetMobileTrackCount object =
                new GetMobileTrackCount();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getMobileTrackCount".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetMobileTrackCount)com.webservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
