 ...
 */
            ...
            /**
            *  IsExitCtrackAisInfo bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class IsExitCtrackAisInfo
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = isExitCtrackAisInfo
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":isExitCtrackAisInfo",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "isExitCtrackAisInfo",
    ...
    public static class Factory{
        ...
        */
        public static IsExitCtrackAisInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            IsExitCtrackAisInfo object =
                new IsExitCtrackAisInfo();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"isExitCtrackAisInfo".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (IsExitCtrackAisInfo)com.webservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
