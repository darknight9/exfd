 ...
 */
            ...
            /**
            *  Get_FairplayOwnership bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Get_FairplayOwnership
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = get_FairplayOwnership
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":get_FairplayOwnership",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
    ...
    public static class Factory{
        ...
        */
        public static Get_FairplayOwnership parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Get_FairplayOwnership object =
                new Get_FairplayOwnership();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"get_FairplayOwnership".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Get_FairplayOwnership)com.webservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
