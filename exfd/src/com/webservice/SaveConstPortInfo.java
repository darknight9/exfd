 ...
 */
            ...
            /**
            *  SaveConstPortInfo bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SaveConstPortInfo
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = saveConstPortInfo
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":saveConstPortInfo",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "saveConstPortInfo",
    ...
    public static class Factory{
        ...
        */
        public static SaveConstPortInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SaveConstPortInfo object =
                new SaveConstPortInfo();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"saveConstPortInfo".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SaveConstPortInfo)com.webservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
