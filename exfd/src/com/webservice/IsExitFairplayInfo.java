 ...
 */
            ...
            /**
            *  IsExitFairplayInfo bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class IsExitFairplayInfo
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = isExitFairplayInfo
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":isExitFairplayInfo",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "isExitFairplayInfo",
    ...
    public static class Factory{
        ...
        */
        public static IsExitFairplayInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            IsExitFairplayInfo object =
                new IsExitFairplayInfo();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"isExitFairplayInfo".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (IsExitFairplayInfo)com.webservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
