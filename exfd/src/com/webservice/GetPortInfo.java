 ...
 */
            ...
            /**
            *  GetPortInfo bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetPortInfo
    ...
    public static class Factory{
        ...
        */
        public static GetPortInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetPortInfo object =
                new GetPortInfo();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getPortInfo".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetPortInfo)com.webservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
