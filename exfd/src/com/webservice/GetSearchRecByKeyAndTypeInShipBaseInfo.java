...
/**
 * GetSearchRecByKeyAndTypeInShipBaseInfo.java
 *
 ...
 */
            ...
            /**
            *  GetSearchRecByKeyAndTypeInShipBaseInfo bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetSearchRecByKeyAndTypeInShipBaseInfo
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = getSearchRecByKeyAndTypeInShipBaseInfo
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getSearchRecByKeyAndTypeInShipBaseInfo",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                ...
                if (localArg0Tracker){
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    writeStartElement(null, namespace, "arg4", xmlWriter);
                                               ...
                                               if (localArg4==java.lang.Integer.MIN_VALUE) {
    ...
    public static class Factory{
        ...
        */
        public static GetSearchRecByKeyAndTypeInShipBaseInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetSearchRecByKeyAndTypeInShipBaseInfo object =
                new GetSearchRecByKeyAndTypeInShipBaseInfo();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getSearchRecByKeyAndTypeInShipBaseInfo".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetSearchRecByKeyAndTypeInShipBaseInfo)com.webservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
