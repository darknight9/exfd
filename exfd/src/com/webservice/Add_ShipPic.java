 ...
 */
            ...
            /**
            *  Add_ShipPic bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Add_ShipPic
    ...
    public static class Factory{
        ...
        */
        public static Add_ShipPic parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Add_ShipPic object =
                new Add_ShipPic();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"add_ShipPic".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Add_ShipPic)com.webservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
