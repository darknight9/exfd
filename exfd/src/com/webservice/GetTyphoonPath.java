 ...
 */
            ...
            /**
            *  GetTyphoonPath bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetTyphoonPath
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getTyphoonPath",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getTyphoonPath",
    ...
    public static class Factory{
        ...
        */
        public static GetTyphoonPath parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetTyphoonPath object =
                new GetTyphoonPath();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getTyphoonPath".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetTyphoonPath)com.webservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
