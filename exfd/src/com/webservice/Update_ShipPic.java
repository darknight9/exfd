 ...
 */
            ...
            /**
            *  Update_ShipPic bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Update_ShipPic
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":update_ShipPic",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "update_ShipPic",
    ...
    public static class Factory{
        ...
        */
        public static Update_ShipPic parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Update_ShipPic object =
                new Update_ShipPic();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"update_ShipPic".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Update_ShipPic)com.webservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
