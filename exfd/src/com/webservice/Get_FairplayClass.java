 ...
 */
            ...
            /**
            *  Get_FairplayClass bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Get_FairplayClass
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = get_FairplayClass
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":get_FairplayClass",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "get_FairplayClass",
    ...
    public static class Factory{
        ...
        */
        public static Get_FairplayClass parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Get_FairplayClass object =
                new Get_FairplayClass();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"get_FairplayClass".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Get_FairplayClass)com.webservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
