 ...
 */
            ...
            /**
            *  AddLogLog bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AddLogLog
    ...
    public static class Factory{
        ...
        */
        public static AddLogLog parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AddLogLog object =
                new AddLogLog();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"addLogLog".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AddLogLog)com.webservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
