 ...
 */
            ...
            /**
            *  GetMobilesInfo bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetMobilesInfo
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getMobilesInfo",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getMobilesInfo",
    ...
    public static class Factory{
        ...
        */
        public static GetMobilesInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetMobilesInfo object =
                new GetMobilesInfo();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getMobilesInfo".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetMobilesInfo)com.webservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
