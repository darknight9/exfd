 ...
 */
            ...
            /**
            *  Get_FairplayGg bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Get_FairplayGg
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":get_FairplayGg",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "get_FairplayGg",
    ...
    public static class Factory{
        ...
        */
        public static Get_FairplayGg parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Get_FairplayGg object =
                new Get_FairplayGg();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"get_FairplayGg".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Get_FairplayGg)com.webservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
